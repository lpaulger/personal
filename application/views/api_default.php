...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Welcome to Me2TeamAPI</title>
    ...
    <body>
        ...
        <h1>Welcome to Me2TeamAPI!</h1>

        <p>The page you are looking at is being generated dynamically by Me2TeamAPI.</p>

        <ul>
            <li><a href="<?php echo site_url('api/users/team'); ?>">Users</a> - defaulting to XML</li>
            <li><a href="<?php echo site_url('api/users/format/csv'); ?>">Users</a> - get it in CSV</li>
            <li><a href="<?php echo site_url('api/user/username/lpaulger'); ?>">User lucasmp</a> - defaulting to JSON</li>
            <li><a href="<?php echo site_url('api/user/username/lpaulger/format/xml'); ?>">User lucasmp</a> - get it in XML</li>
